		...
		<div class="col-md-3 col-sm-12">
			<div class="widget padding-0 white-bg">
				...
				<div class="thumb-over">
					<img src="#" alt="" width="100" class="rounded-circle">
				</div>
				<div class="padding-20 text-center">
					<p class="lead font-500 margin-b-0"><!--kullanici_adi --></p>
							...
							<div class="card-block">
								<form id="signupForm1" method="post" class="form-horizontal">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" id="firstname1" name="kullanici_adsoyad" />
									</div>

									<div class="form-group">
										<label for="lastname1">Kullanıcı Adı</label>
										<input type="text" class="form-control" id="lastname1" name="kullanici_adi"/>
									</div>
						...
						<div class="widget white-bg">
							...
							<div class="card-block">
								<form method="post" class="form-horizontal" enctype="multipart/form-data">
									...
									<div class="form-group">
										<input type="hidden" class="form-control" name="eski_yol"/>
									</div>
