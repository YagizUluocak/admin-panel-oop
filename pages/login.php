                  ...
                  <form action="controller/function.php" method="POST">
                    <div class="form-group">                                      
                      ...
                      <div class="group-icon">
                        <input name="kullanici_adi" id="exampleuser1" type="text" value="admin" readonly="" class="form-control" required="">
                    ...
                    <div class="form-group">
                      ...
                      <div class="group-icon">
                        <input name="kullanici_pass" id="exampleInputPassword1" type="password" value="admin" readonly="" class="form-control">
