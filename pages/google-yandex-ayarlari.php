						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<textarea style="height: 100px;" type="text" name="motor_analitik" class="form-control">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<textarea style="height: 100px;" type="text" name="motor_metrika" class="form-control">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<textarea style="height: 50px;" type="text" name="motor_gonay" class="form-control">
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="col-md-12">
									...
									<textarea style="height: 50px;" type="text" name="motor_yonay" class="form-control">
