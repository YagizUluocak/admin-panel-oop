				...
				<div class="card-block">
						...
						<form method="POST" class="form-horizontal">
							<div class="form-group">
								<div class="row">
									<input type="hidden" name="counter_id" class="form-control">
									<div class="col-md-4">
										<label>Conter Adı</label>
										<input type="text" name="counter_isim" class="form-control">
									</div>
									<div class="col-md-2">
										<label>Conter Sayı</label>
										<input type="text" name="counter_rakam" class="form-control">
									</div>	
									<div class="col-md-3">
										<label>Conter İcon</label> <small>Simdiki icon -> <i class="fa "></i></small>
										<select name="counter_icon" class="form-control m-b">
											<option>&#xf101; icon seç</option>								
