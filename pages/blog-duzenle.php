			...
			<div class="card">
				...
				<div class="card-block">
					...
					<form method="POST" action="controller/function.php" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="form-group">
							<label>İçerik</label>
							<textarea class="summernote" name="blog_detay">
						...
						<div class="form-group">
							<label>Title</label>
							<input type="text" name="blog_title" class="form-control form-control-rounded">
						</div>

						<div class="form-group">
							<label>Description</label>
							<input name="blog_descr" type="text" class="form-control form-control-rounded">
						</div>

						<div class="form-group">
							<label>Keywords</label>
							<input type="text" name="blog_keyword" class="form-control form-control-rounded">
